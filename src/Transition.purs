...
foreign import attrIFn           :: ∀ d v eff. EffFn3 (d3::D3|eff) String (InterpolatorFn v d) (Transition d) (Transition d)
foreign import styleIFn          :: ∀ d v eff. EffFn3 (d3::D3|eff) String (InterpolatorFn v d) (Transition d) (Transition d)
foreign import styleTweenFn      :: ∀ d v eff. EffFn3 (d3::D3|eff) String (InterpolatorFn v d) (Transition d) (Transition d)
...
tStyleTween :: ∀ d v eff. String -> (InterpolatorFn v d) -> Transition d -> Eff (d3::D3|eff) (Transition d)
