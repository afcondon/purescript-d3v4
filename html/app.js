...
(function(exports) {
  // Generated by psc version 0.9.2
  "use strict";
  var $foreign = PS["Graphics.D3.Unsafe"];
  var Graphics_D3_Base = PS["Graphics.D3.Base"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var Data_Function_Eff = PS["Data.Function.Eff"];        
  var unsafeToFunction = Data_Function_Eff.runEffFn1($foreign.unsafeToFunctionImpl);
  var unsafeRange = Data_Function_Eff.runEffFn2($foreign.unsafeRangeImpl);
  var unsafeDomain = Data_Function_Eff.runEffFn2($foreign.unsafeDomainImpl);
  var unsafeCopy = Data_Function_Eff.runEffFn1($foreign.unsafeCopyImpl);
...
(function(exports) {
  // Generated by psc version 0.9.2
  "use strict";
  var $foreign = PS["Graphics.D3.Util"];
  var Prelude = PS["Prelude"];
