...
})(PS["D3.Collections.Map"] = PS["D3.Collections.Map"] || {});
...
(function(exports) {
  // Generated by psc version 0.9.2
  "use strict";
  var $foreign = PS["D3.Collections.Map"];
  var Prelude = PS["Prelude"];
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var D3_Base = PS["D3.Base"];
  var Data_Function_Eff = PS["Data.Function.Eff"];
  var Data_Maybe = PS["Data.Maybe"];                                  
  var d3Map = function (c) {
      return function (v) {
          if (v instanceof Data_Maybe.Nothing) {
              return Data_Function_Eff.runEffFn1($foreign.d3MapFn)(c);
          };
          if (v instanceof Data_Maybe.Just) {
              return Data_Function_Eff.runEffFn2($foreign.d3MapFnFn)(c)(Data_Function_Eff.mkEffFn1(v.value0));
          };
          throw new Error("Failed pattern match at D3.Collections.Map line 72, column 1 - line 72, column 39: " + [ c.constructor.name, v.constructor.name ]);
      };
  };
  exports["d3Map"] = d3Map;
})(PS["D3.Collections.Map"] = PS["D3.Collections.Map"] || {});
...
(function(exports) {
  ...
  var Control_Monad_Eff = PS["Control.Monad.Eff"];
  var D3_Base = PS["D3.Base"];
  var D3_Collections = PS["D3.Collections"];
  var Data_Function_Eff = PS["Data.Function.Eff"];
  var Data_Maybe = PS["Data.Maybe"];        
  var Band = (function () {
      function Band() {
  ...
  var d3Scale = function (v) {
      ...
      throw new Error("Failed pattern match at D3.Scale line 103, column 1 - line 103, column 63: " + [ v.constructor.name ]);
  };                                                        
...
(function(exports) {
  ...
  var D3_Collections_Map = PS["D3.Collections.Map"];
  var Data_Semigroup = PS["Data.Semigroup"];
  var Data_Show = PS["Data.Show"];
  var Control_Applicative = PS["Control.Applicative"];
  var Data_Unit = PS["Data.Unit"];        
  ...
  var main = function __do() {
      ...
      var v3 = D3_Collections_Map.d3Map(frequencies)(new Data_Maybe.Just(function (d) {
          return d.letter;
      }))();
      var v4 = Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(D3_Scale.d3Scale(D3_Scale.Band.value))(D3_Scale.rangeRound(0.0)(width)))(D3_Scale.padding(0.1))();
      var v5 = Control_Bind.bind(Control_Monad_Eff.bindEff)(D3_Scale.d3Scale(D3_Scale.Linear.value))(D3_Scale.rangeRound(height)(0.0))();
      var v6 = Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Function.applyFlipped(v)(D3_Selection.append("g")))(D3_Selection.attr("transform")(new D3_Base.SetAttr("translate(" + (Data_Show.show(Data_Show.showNumber)(margin.left) + ("," + (Data_Show.show(Data_Show.showNumber)(margin.top) + ")"))))))();
      Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Function.applyFlipped(v6)(D3_Selection.append("g")))(D3_Selection.attr("class")(new D3_Base.SetAttr("axis axis--x"))))(D3_Selection.attr("transform")(new D3_Base.SetAttr("translate(0," + (Data_Show.show(Data_Show.showNumber)(height) + ")"))))();
      Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Function.applyFlipped(v6)(D3_Selection.append("g")))(D3_Selection.attr("class")(new D3_Base.SetAttr("axis axis--y"))))(D3_Selection.append("text")))(D3_Selection.attr("transform")(new D3_Base.SetAttr("rotate(-90)"))))(D3_Selection.attr("y")(new D3_Base.SetAttr(6.0))))(D3_Selection.attr("dy")(new D3_Base.SetAttr("0.71em"))))(D3_Selection.attr("text-anchor")(new D3_Base.SetAttr("end"))))(D3_Selection.text(new D3_Base.Value("Frequency")))();
      Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Control_Bind.bind(Control_Monad_Eff.bindEff)(Data_Function.applyFlipped(v6)(D3_Selection.selectAll(".bar")))(D3_Selection.dataBind(new D3_Base.Data(frequencies))))(D3_Selection.enter))(D3_Selection.append("rect")))(D3_Selection.attr("class")(new D3_Base.SetAttr("bar"))))(D3_Selection.attr("x")(new D3_Base.AttrFn(function (d) {
          return function (i) {
              return function (nodes) {
                  return function (el) {
                      return function __do() {
                          var v7 = D3_Scale.scale(i)(v4)();
                          return v7;
                      };
                  };
              };
          ...
          return function (i) {
              return function (nodes) {
                  return function (el) {
                      return function __do() {
                          var v7 = D3_Scale.scale(d.frequency)(v5)();
                          return v7;
                      };
                  };
              };
          };
      }))))(D3_Selection.attr("width")(new D3_Base.SetAttr(D3_Scale.bandwidth(v4)))))(D3_Selection.attr("height")(new D3_Base.AttrFn(function (d) {
          return function (i) {
              return function (nodes) {
                  return function (el) {
                      return function __do() {
